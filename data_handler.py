...
# This list has been restored as requested.
# The script will FAIL if these files are not in the specified directory.
csv_files_to_import = [
...
if csv_files_to_import:
    ...
    print("No local CSV files specified. Creating an empty DataFrame.")
    market_quarterly = pd.DataFrame()
...
# This part depends on the local CSVs being loaded successfully.
...
# --- Impute the market_quarterly data ---
# This part also depends on the local CSVs.
